(**
---
title: Consuming Asynchronous Sequences
category: Documentation
categoryindex: 2
index: 4
description: How to consume F# asynchronous sequences using iteration, folding, searching and collection operations.
keywords: F#, asynchronous sequences, AsyncSeq, iter, fold, pick, toArray, toList, sum, average
---
*)
(*** condition: prepare ***)
#nowarn "211"
