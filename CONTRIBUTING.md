# Contributing to FSharp.Control.AsyncSeq

FSharp.Control.AsyncSeq is primarily maintained through agentic development under human guidance.
...
If a pull request is the agreed approach, follow [AGENTS.md], add tests for behavior changes, update
documentation and release notes when applicable, and run:
...
[AGENTS.md]: AGENTS.md
[GitHub issues]: https://github.com/fsprojects/FSharp.Control.AsyncSeq/issues
